...
Queue.DisplayQueueCount = GetConvar("sv_displayqueuetags", "true") == "true" and true or false
...
local function playerConnect(source, setKickReason, deferrals)
    ...
    if Queue:NotFull(true) and _Queue.JoinDelay <= GetGameTimer() then
        ...
        TriggerEvent("bj-log:server:CreateLog", "joinleave", "Queue", "orange", "**".. name .. "** joining..")
        TriggerEvent("bj-log:server:sendLog", ids[1], "joinedqueue", {})
