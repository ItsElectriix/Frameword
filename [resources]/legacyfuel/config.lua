...
Config.Strings = {
	ExitVehicle = "Exit vehicle to refuel",
	EToRefuel = "[~g~E~w~] Refuel Vehicle",
	JerryCanEmpty = "Jerry can is empty",
	FullTank = "Tank is full",
	PurchaseJerryCan = "[~g~E~w~] Buy Jerry can ~g~" .. Config.JerryCanCost,
	CancelFuelingPump = "[~g~E~w~] Cancel",
	CancelFuelingJerryCan = "[~g~E~w~] Cancel"
}
...
Config.GasStations = {
	...
	--vector3(1039.958, 2671.134, 39.550), -- route 68/grand senora desert
	vector3(1207.260, 2660.175, 37.899),
	vector3(2539.685, 2594.192, 37.944),
	vector3(2679.858, 3263.946, 55.240),
	vector3(2005.055, 3773.887, 32.403),
	--vector3(1687.156, 4929.392, 42.078), -- grapeseed
...
TriggerEvent('BJCore:GetObject', function(obj)
    BJCore = obj
    Config.Strings['PurchaseJerryCan'] = "[~g~E~w~] Buy Jerry can ~g~".. BJCore.Config.Currency.Symbol .. Config.JerryCanCost
end)
