...
function toggleVoice(plySource, enabled, submixType)
    ...
    if enabled and submixType and CustomVolumes[submixType] then
        MumbleSetVolumeOverrideByServerId(plySource, enabled and CustomVolumes[submixType] or -1.0)
    else
