RegisterServerEvent('BJCore:DebugSomething')
AddEventHandler('BJCore:DebugSomething', function(resource, obj, depth)
...
BJCore.Debug = function(resource, obj, depth)
    TriggerEvent('BJCore:DebugSomething', resource, obj, depth)
end

BJCore.ShowError = function(resource, msg)
    print("\x1b[31m["..resource..":ERROR]\x1b[0m "..msg)
end

BJCore.ShowSuccess = function(resource, msg)
