...
function Menu.addButton(name, func,args,args2,extra,damages,bodydamages,fuel)
...
function Menu.updateSelection() 
	...
	elseif IsControlJustPressed(1, 215) then
		MenuCallFunction(Menu.GUI[Menu.selection +1]["func"], Menu.GUI[Menu.selection +1]["args"], Menu.GUI[Menu.selection +1]["args2"])
		PlaySound(-1, "SELECT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 0, 0, 1)
	end
	local iterator = 0
...
function MenuCallFunction(fnc, arg, args2)
	_G[fnc](arg, args2)
end
