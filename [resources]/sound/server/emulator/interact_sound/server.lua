...
AddEventHandler('InteractSound_SV:PlayWithinDistance', function(maxDistance, soundFile, soundVolume)
	TriggerClientEvent('InteractSound_CL:PlayWithinDistance', -1, GetEntityCoords(GetPlayerPed(source)), maxDistance, soundFile, soundVolume)
end)

RegisterServerEvent('InteractSound_SV:PlayWithinDistancePos')
AddEventHandler('InteractSound_SV:PlayWithinDistancePos', function(pos, maxDistance, soundFile, soundVolume)
	TriggerClientEvent('InteractSound_CL:PlayWithinDistance', -1, pos, maxDistance, soundFile, soundVolume)
end)