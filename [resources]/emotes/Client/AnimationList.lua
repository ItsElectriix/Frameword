...
DP.Dances = {
   ...
   ["strip"] = {"mini@strip_club@lap_dance@ld_girl_a_song_a_p1", "ld_girl_a_song_a_p1_f", "Strip Tease", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ...
   ["strip3"] = {"mini@strip_club@private_dance@part3", "priv_dance_p3", "Strip Tease 3", AnimationOptions =
   {
       EmoteLoop = true
   }},
    ["pole"] = {"mini@strip_club@pole_dance@pole_dance1", "pd_dance_01", "Pole Dance", AnimationOptions =
   {
       EmoteLoop = true
   }},
    ["pole2"] = {"mini@strip_club@pole_dance@pole_dance2", "pd_dance_02", "Pole Dance 2", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["pole3"] = {"mini@strip_club@pole_dance@pole_dance3", "pd_dance_03", "Pole Dance 3", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["pole4"] = {"mini@strip_club@pole_dance@pole_c_2_prvd_a", "pole_c_2_prvd_a", "Pole Dance back", AnimationOptions =
   {
       EmoteLoop = true
   }},
    ["pole5"] = {"mini@strip_club@pole_dance@pole_c_2_stage", "pole_c_2_stage", "Pole Dance back 2", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["lapdance"] = {"mini@strip_club@private_dance@part1", "priv_dance_p1", "Lap Dance", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ...
   ["lapdance3"] = {"mini@strip_club@lap_dance@ld_girl_a_song_a_p2", "ld_girl_a_song_a_p2_f", "Lap Dance 3", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["lapdance4"] = {"mini@strip_club@lap_dance@ld_girl_a_song_a_p3", "ld_girl_a_song_a_p3_f", "Lap Dance 4", AnimationOptions =
   {
       EmoteLoop = true
   }},
   ["lapdance5"] = {"mp_safehouse", "lap_dance_girl", "Lap Dance 5", AnimationOptions =
   {
       EmoteLoop = true,
   }},
...
DP.DogEmotes = {
   ["dogsleep"] = {"creatures@rottweiler@amb@sleep_in_kennel@", "sleep_in_kennel", "Lay Down", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["alert"] = {"creatures@rottweiler@indication@", "indicate_ahead", "Alert Ahead", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["alert2"] = {"creatures@rottweiler@indication@", "indicate_low", "Alert Low", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["alert3"] = {"creatures@rottweiler@indication@", "indicate_high", "Alert High", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["taunt"] = {"creatures@rottweiler@melee@streamed_taunts@", "taunt_01", "Taunt 1", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["taunt2"] = {"creatures@rottweiler@melee@streamed_taunts@", "taunt_02", "Taunt 2", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["hump"] = {"creatures@rottweiler@amb@", "hump_enter_chop", "Hump", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["hump2"] = {"creatures@rottweiler@amb@", "hump_loop_chop", "Hump Loop", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["swim"] = {"creatures@rottweiler@swim@", "swim", "Swim", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["swim2"] = {"creatures@rottweiler@swim@", "swim", "Swim", AnimationOptions =
   {
	   EmoteMoving = true,
       EmoteLoop = true,
   }},
   ["car"] = {"creatures@rottweiler@in_vehicle@4x4", "sit", "Sit in Car", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["car2"] = {"creatures@rottweiler@in_vehicle@4x4", "lean_left", "Lean in Car", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["beg"] = {"creatures@rottweiler@tricks@", "beg_loop", "Beg", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["paw"] = {"creatures@rottweiler@tricks@", "paw_right_loop_right", "Give Paw", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dpoo"] = {"creatures@rottweiler@move", "dump_loop", "Poop", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["dpee"] = {"creatures@rottweiler@move", "pee_right_idle", "Pee", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["fetch"] = {"creatures@rottweiler@move", "fetch_pickup", "Fetch Fetch Pickup", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["fetch2"] = {"creatures@rottweiler@move", "fetch_drop", "Fetch Drop", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["melee"] = {"creatures@rottweiler@move", "melee", "Bite", AnimationOptions =
   {
       EmoteLoop = false,
   }},
   ["dog1"] = {"amb@lo_res_idles@", "creatures_world_rottweiler_sitting_lo_res_base", "Sit Down", AnimationOptions =
   {
       EmoteLoop = true,
   }}
}
...
DP.Emotes = {
   ...
   ["under"] = {"rcmpaparazzo_2", "shag_loop_poppy", "Under", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["ontop"] = {"rcmpaparazzo_2", "shag_loop_a", "On top", AnimationOptions =
   {
       EmoteLoop = true,
   }},
    ["motorboat"] = {"mini@strip_club@backroom@", "stripper_b_backroom_idle_be", "Motorboat", AnimationOptions =
   {
       EmoteLoop = true,
   }},
...
-----------------------------------------------------------------------------------------------------------
   ...
   ["smokeweed"] = {"Scenario", "WORLD_HUMAN_SMOKING_POT", "Smoke Weed"},
...
-----------------------------------------------------------------------------------------------------
   ...
   ["tray"] = {"anim@heists@box_carry@", "idle", "Tray", AnimationOptions =
   {
       ...
       PropBone = 28422,
       PropPlacement = {0.0, 0.0, -0.13, 5.0, 0.0, 0.0},
       EmoteMoving = true,
       EmoteLoop = true
   }},
