ScaleformMinigames['Datacrack'] = function(mgData)
    local output = {}
    ...
    function F_02668(arg1)
        ...
        Citizen.CreateThread(function()
            ...
            PushScaleformMovieFunctionParameterInt(mgData.background and mgData.background or 0)
            PopScaleformMovieFunctionVoid()
            ...
            while true do
                ...
                if Dat_2[1].val4 == false and Dat_2[2].val4 == false and Dat_2[3].val4 == false and Dat_2[4].val4 == false and Dat_2[5].val4 == false and Dat_2[6].val4 == false and Dat_2[7].val4 == false then
                    ...
                    Citizen.Wait(2500)
                    stophack = true
                    TriggerEvent('bj:minigameResult', 'Datacrack', true, {})
                    return
                end
                Citizen.Wait(1)
            end
    ...
    function Abort()
        stophack = true
        TriggerEvent('bj:minigameResult', 'Datacrack', false, {})
    end
    ...
    Start(mgData.difficulty and mgData.difficulty or 5)
end